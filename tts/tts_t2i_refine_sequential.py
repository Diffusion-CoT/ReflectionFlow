...
def sample(
    ...
    for imgname in full_imgnames:
        r1, scores1 = model.generate_content([Image.open(imgname), original_prompt])
        if r1 == "yes":
    ...
    # best_img_path = os.path.join(midimg_path, f"{search_round}_round@.png")
