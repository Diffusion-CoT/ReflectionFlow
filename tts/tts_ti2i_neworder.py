...
def sample(
    ...
    if refinement_performed:
        best_img_refine_prompt = updated_prompt[0]
    ...
    conditionimg = condition_cls(condition=bestimg, condition_type="cot", position_delta=position_delta)
