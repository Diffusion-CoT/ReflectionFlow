...
from trainer import Qwen2VLRewardModelBT, ImageVLMRewardTrainer, compute_multi_attr_accuracy, PartialEmbeddingUpdateCallback
...
def create_dataset(data_config, meta_file=None):
    ...
    convert_func = lambda example: convert_GSB_csv_to_reward_data(example, data_config.data_dir, data_config.eval_dim, 
                                                                  data_config.max_frame_pixels, data_config.prompt_template_type)
