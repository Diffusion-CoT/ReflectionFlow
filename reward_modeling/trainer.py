...
from reward_modeling.utils import get_peft_state_non_lora_maybe_zero_3
...
class Qwen2VLRewardModelBT(Qwen2_5_VLForConditionalGeneration):
...
class ImageVLMRewardTrainer(RewardTrainer):
    def __init__(self, loss_type="regular", enable_noise_in_eval=False, *args, **kwargs):
        super(ImageVLMRewardTrainer, self).__init__(*args, **kwargs)
    ...
    #     pdb.set_trace()
    #     return super(ImageVLMRewardTrainer, self).training_step(model, inputs, num_items_in_batch)
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        ...
        if isinstance(self.model, PeftModel):
            ...
            super(ImageVLMRewardTrainer, self)._save_checkpoint(model, trial, metrics)
